Feature: Nopcommerce Registration
  ...
  Scenario Outline: I shoulld not be able to registration with invalid data on mandatory field (*) registration page
  ...
  Scenario: I should be able to register with valid mandatory (*) field data on registration page
    ...
    And     I enter the last name "Bakshi"
    And     I enter Email "bakshi@gmail.com"
    And     I enter the password "456897"
